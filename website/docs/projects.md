...
Projects maintained by the Nothing community.

## Glyph Tools

A collection of tools for creating custom Glyph tones and compositions.
...
| [Kdear](https://github.com/AndresLopezzz/Kdear-nothing-cmf) | AndresLopezzz | KDE Plasma 6 desktop widget to control ANC, EQ, and battery for Nothing and CMF earbuds |
...
Custom fonts and styling tools to complement your Nothing-inspired setup.
...
Utilities for creating and generating Nothing-style wallpapers.
...
Web-based applications inspired by Nothing OS.
...
Essential resources including wikis, firmware archives, audio control utilities, and system repair tools.
